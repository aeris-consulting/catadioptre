 ...
 * For reference, see the [JVM specification, section 4.3](http://docs.oracle.com/javase/specs/jvms/se7/html/jvms-4.html#jvms-4.3).
 */
internal object JvmDescriptorTypeVisitor : AbstractTypeVisitor9<String, Types>() {
    ...
    override fun visitNull(t: NullType, types: Types) = visitUnknown(t, types)

    override fun visitError(t: ErrorType, types: Types) = visitUnknown(t, types)

    override fun visitUnknown(t: TypeMirror, types: Types): String = error("Unsupported type $t")

    override fun visitUnion(t: UnionType, types: Types) = visitUnknown(t, types)

    override fun visitIntersection(t: IntersectionType, types: Types) = visitUnknown(t, types)
}
