...
public abstract class AbstractCatadioptreExample<T extends Number, V> implements CatadioptreInterface<T> {
	...
	public AbstractCatadioptreExample(final T typedProperty, final V defaultArgumentTypedProperty2) {
